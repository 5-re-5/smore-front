...
import type { ChatUser, UserUpdateData } from '../types/user.interface.ts';
...
interface UserState {
  ...
  updateUser: (sid: string, data: UserUpdateData['data']) => void;
...
// 채팅참가자 상태관리
export const useChattingUserListStore = create<UserState>((set) => ({
  users: [],
