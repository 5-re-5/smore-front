const ExtraFeaturesSection = () => {
  return (
    <section className="relative w-full h-[730px] bg-white font-black-han-sans overflow-hidden">
      ...
      {/* 오른쪽: 섹션 타이틀 */}
      <div className="absolute top-[104px] left-[950px] text-left text-[2.75rem] leading-[56px] text-dimgray w-[430px]">
        <div>
          <span>S’m</span>
      ...
      <div className="absolute top-[300px] left-[960px] flex flex-col gap-8">
        <div className="flex items-center gap-5">
          ...
          <span className="text-[1.53rem] text-royalblue tracking-[-0.02em] font-black-han-sans">
            포모도로 시계
          </span>
        </div>
        <div className="flex items-center gap-5">
